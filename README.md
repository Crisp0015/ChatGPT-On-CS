...
<a href="[[1.0.5-beta.exe](https://github.com/cs-lazy-tools/ChatGPT-On-CS/releases/download/v1.0.5-beta.1/1.0.5-beta.exe)]" style="display: inline-block; background-color: #008CBA; color: white; padding: 10px 20px; text-align: center; text-decoration: none; font-weight: bold; border-radius: 5px; margin: 4px 2px; cursor: pointer;">点击下载</a>
